...
var Park = function (_Element) {
    ...
    function Park(name, buildYear, area, numberTrees) {
    ...
    _createClass(Park, [{
        ...
        value: function treeDensity() {
            var density = this.numberTrees / this.area;
...
function reportParks(park) {
    ...
    // Density
    park.forEach(function (element) {
        element.treeDensity();
    });

    var ages = park.map(function (el) {
    ...
    var index = park.map(function (element) {
        return element.numberTrees;
...
function reportStreet(street) {
    ...
    var _calc3 = calc(street.map(function (element) {
    ...
    // classify sizes
    street.forEach(function (element) {
